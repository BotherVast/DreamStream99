...
function renderOne(element, settings) {
  ...
  const fontFamily = settings.fontFamily || '"Pixelated MS Sans Serif", "FZ Pixel 12", "WenQuanYi Bitmap Song 12px", "Microsoft YaHei UI", "PingFang SC", "Noto Sans CJK SC", sans-serif';
